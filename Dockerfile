...
RUN git clone https://github.com/ONLYOFFICE/document-server-package.git -b ${DS_PACKAGE_BRANCH} && \
    cd document-server-package
RUN PRODUCT_VERSION="${DS_VERSION}" BUILD_NUMBER="${DS_BUILD_NUMBER}" make deb
